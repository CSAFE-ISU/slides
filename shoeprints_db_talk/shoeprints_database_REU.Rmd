...
# Shoeprints Data Collection

# Introduction

## A Question of Interest

- Footwear impressions are common in crime scenes
- Was this shoeprint left by this particular shoeprint?

<img src="images/sample_image.JPG" width = "28%">
<img src="images/nike_pic.jpg" width = "26%">

## Questions About the Crime Scene Print

- Can we determine brand, model or size? These are **class characteristics**
- Can we find scratches, cuts or other marks? These are **individual characteristics**
- The individual characteristics are also known as randomly acquired characteristics (**RACs**)

<img src="images/shoe characteristics.png" width = "60%">

## Some challenges

- Overlayed prints
- Obstacles created by the substrate
- Potential problems while casting (e.g., on dirt or snow) or lifting shoeprints evidence

# Data Collection

## Why do we need a shoeprints database?
...
- Collaborators from the Israeli police: Distribution and shapes of RACs
- Souyoung Park: Semi-automated method to compare shoeprints
- Martin Silerio: Side-by-side analysis of cross-sections

## Possible Extensions

- Create crime-scene-like prints in such way that:
  + Lift wet and dry surfaces
  + Cast on difficult surfaces

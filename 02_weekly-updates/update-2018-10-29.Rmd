...
<img src = "images/Nate/unanchored_logSLR_logLR.png" width="80%" height = "80%"/>
...
- Returning a list of features given a grapheme as input
- Examples: Aspect Ratio, Skew / Tilt of letter, Length of loops
---
class: inverse
# Amy

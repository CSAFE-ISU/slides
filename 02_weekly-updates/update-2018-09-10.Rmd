...
```{r, eval = FALSE}
presenter <- c("Amy", "Ben", "Nick", "Ganesh", "Nate", 
               "Sam", "Guillermo", "James", "Kiegan", 
               "Danica", "Susan", "Miranda", "Heike")
sample(presenter)
...
-Got the internship! Living in DC this summer
-Finished all but 1 step of Preprocessing Alg
...
- Thanks to everybody who helped with all the visits from FTEs!

- Hamby set 36 scans done, analysis running

- Hamby clone set 224 scans done to 90%

- Hamby set 224 arrived

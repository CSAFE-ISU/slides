...
- Fundamental understanding of how environmental factors can affect evidence   
    - Time, scanning process  
- Scientific foundations for the evaluation of evidence in support of qualified and definitive conclusions  
...
\vspace{7mm}
![](images/Amy_NIJTWG1.png)\  


## Current Gaps/Research Needs
Research needs identified by the NIJ TWG  
\vspace{7mm}
![](images/Amy_NIJTWG2.png)\  

## Current Gaps/Research Needs
Research needs identified by the OSAC:   
\vspace{5mm}
![](images/Amy_OSAC3.png){width=350px}\    


## Current Gaps/Research Needs
Research needs identified by the OSAC:   
\vspace{15mm}
![](images/Amy_OSAC4.png){width=350px}\     


## Current Gaps/Research Needs
Research needs identified by the OSAC 
\vspace{2mm}
![](images/Amy_OSAC1.png){width=350px}\   
[...background information, references, etc. ...]
![](images/Amy_OSAC2.png){width=350px}\ 

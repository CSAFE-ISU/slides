...
The slides for today are in the *slides* repo (pull it/fork it) or follow along on 
...
![](https://github.com/erichare/dissertation/blob/master/images/schema.png?raw=true)

## Your Turn

- Log into the csafe RStudio server at https://isu-csafe.stat.iastate.edu/rstudio/
- Open the file `scripts/database-access.R` and try out the code

...
<img alt="leslie is my spirit animal" src="https://media.giphy.com/media/K6WNEiu0sqk12/giphy.gif" width=400>

## But after that

<img alt="drunk ron is my spirit animal" src="https://media.giphy.com/media/lfmLzyIbqgCI0/giphy.gif" width=600>

Then all human factors research all the time! 😍
...
## Graphemes Are Separated.

<img src="images/NickGraphemesTestDoc.PNG" width=500>

## What I'm working on:

Needs to be better:

1. Reading in and binarizing original image.
2. There may be something weird with one of the path finding algorithms. See L-E connection in previous London.
3. Write thinning algorithm in C++ to make it faster.

## Because everyone loves london:

<img src="images/NickLondonGraphemes.gif" width=500>
